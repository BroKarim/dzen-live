...
export const ANIMATED_BACKGROUNDS: Record<string, AnimatedBackgroundMeta> = {
  "none": {
    ...
    component: None,
    preview:
      "url(\"data:image/svg+xml,%3Csvg%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20viewBox%3D%220%200%2032%2032%22%3E%3Cpath%20fill%3D%22%23fff%22%20d%3D%22M30%203.414L28.586%202l-3.432%203.432A13.93%2013.93%200%200%200%2016%202C8.28%202%202%208.28%202%2016c0%203.5%201.3%206.697%203.432%209.154L2%2028.586L3.414%2030l3.432-3.432A13.93%2013.93%200%200%200%2016%2030c7.72%200%2014-6.28%2014-14c0-3.5-1.3-6.697-3.432-9.154zM4%2016C4%209.383%209.383%204%2016%204a11.94%2011.94%200%200%201%207.74%202.845L6.846%2023.741A11.94%2011.94%200%200%201%204%2016m24%200c0%206.617-5.383%2012-12%2012a11.94%2011.94%200%200%201-7.74-2.845L25.155%208.259A11.94%2011.94%200%200%201%2028%2016%22%20%2F%3E%3C%2Fsvg%3E\")",
    defaultConfig: {},
    configFields: [],
  },
  "retro-grid": {
