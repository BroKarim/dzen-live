...
export const ANIMATED_BACKGROUNDS: Record<string, AnimatedBackgroundMeta> = {
  "none": {
    ...
    component: None,
    preview:
      "url('data:image/svg+xml,<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 32 32\"><path fill=\"%23fff\" d=\"M30 3.4L28.6 2l-3.4 3.4A14 14 0 0 0 16 2C8.3 2 2 8.3 2 16c0 3.5 1.3 6.7 3.4 9.2L2 28.6 3.4 30l3.4-3.4A14 14 0 0 0 16 30c7.7 0 14-6.3 14-14 0-3.5-1.3-6.7-3.4-9.2zm-26 12.6C4 9.4 9.4 4 16 4a12 12 0 0 1 7.7 2.8L6.8 23.7A12 12 0 0 1 4 16m24 0c0 6.6-5.4 12-12 12a12 12 0 0 1-7.7-2.8l17.3-17A12 12 0 0 1 28 16\"/></svg>')",
    defaultConfig: {},
    configFields: [],
  },
  "retro-grid": {
